...
<body class="body1">
	<div class="body2">
		...
		<div class="content">
			<div class="center">
				<form name="form1" method="post" action="/mystory/addUserRegister"
					...
					<table align="center">
						<tbody>
							<tr>
								...
								<td align="right">
								<a href="${pageContext.request.contextPath }/toJspPage?whatPage=/index/user_login" style="color:#666;">已有账号！&nbsp;
							...
							<tr>
								...
								<td colspan="2"><p>
										<input type="text" name="u_name" id="username" class="username"
							...
							<tr>
								...
								<td colspan="2"><p>
										<input type="password" name="u_passwd" id="pwd1" class="username"
							...
							<tr>
								...
								<td colspan="2"><p>
										<input type="text"  name="u_phone" id="mobile" class="username"
							...
							<tr>
								...
								<td colspan="2"><p>
										<input type="email" name="u_email"  id="email" class="username"
