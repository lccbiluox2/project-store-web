...
public class IndexControl {
	...
	public ModelAndView indexList(){
		...
		List<TreeShow> treeCategoryList = indexService.finaCategoryTreeShow(top , new TreeShow());
		...
		//商品分类别显示
		/*
		List<TreeShow> flProductList = indexService.finaProductByFL(top,new TreeShow() , 0);
